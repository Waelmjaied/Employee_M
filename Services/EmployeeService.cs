...
namespace EmployeeManagement.Models.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        Task<IEnumerable<Employee>> IEmployeeService.GetEmployees()
        {
            throw new NotImplementedException();
        }

        Task<Employee> IEmployeeService.GetEmployee(int id)
        {
            throw new NotImplementedException();
        }

        Task<Employee> IEmployeeService.UpdateEmployee(Employee employee)
        {
            throw new NotImplementedException();
        }

        Task IEmployeeService.AddEmployee(Employee employee)
        {
            throw new NotImplementedException();
        }
